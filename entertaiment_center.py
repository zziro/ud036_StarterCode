...
titanic = media.Movie(
    ...
    "http://thesource.com/wp-content/uploads/2017/11/Titanic-to-Return-to-"
    "Theaters-for-20th-Anniversary.jpg",
...
gladiator = media.Movie(
    ...
    "https://static0.srcdn.com/wp-content/uploads/2016/09/Russell-Crowe-is-"
    "Maximus-in-Gladiator.jpg",
...
the_notebook = media.Movie(
    ...
    "Sparks.",
    "http://www.movieroomreviews.com/sites/movieroomreviews.com/files/"
    "imagecache/full_size_image/photos/the-notebook-movie-picture-59.jpg",
...
king_kong = media.Movie(
    ...
    "https://vignette.wikia.nocookie.net/skull-island/images/8/89/"
    "King-Kong-Movie-Poster-1-.jpeg",
...
braveheart = media.Movie(
    ...
    "http://static.tvgcdn.net/rovi/showcards/movie/"
    "130677/thumbs/16930914_1242x1656.jpg",
